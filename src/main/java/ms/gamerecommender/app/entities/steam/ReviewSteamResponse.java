...
@JsonDeserialize(using = ReviewSteamResponse.ReviewSteamResponseDeserializer.class)
public record ReviewSteamResponse(int totalPositiveReviews, int totalNegativeReviews) {
    static class ReviewSteamResponseDeserializer extends StdDeserializer<ReviewSteamResponse> {
